...
static JSValue js_global_this(JSContext *ctx) {
...
static int init_module_globalThis(JSContext *ctx, JSModuleDef *m) {
...
JSModuleDef *js_init_module_globalThis(JSContext *ctx, const char *module_name) {
