/**
 * Static-site generator for the qjs-lws GitHub Pages site.
 *
 *   qjsm tools/site/build.js [outdir]      (default outdir: _site)
 *
 * Renders the repo's own markdown (README.md, ChangeLog.md, doc/**) into a
 * self-contained HTML site: a hand-written landing page plus every doc page
 ...
 * links that point at anything else in the repo (lib/, examples/, sources)
...
const REPO = 'rsenn/qjs-lws';
const GITHUB = 'https://github.com/' + REPO;
const TAGLINE = 'libwebsockets bindings for QuickJS';
...
<meta name="description" content="${escAttr(TAGLINE)} — HTTP/1.1, HTTP/2, WebSocket, raw TCP/UDP and TLS in a QuickJS module.">
