...
export function fetch(url, options = {}) {
  ...
  return new Promise((resolve, reject) => {
      ...
      protocols: [
        {
          ...
          onReceiveClientHttp(wsi, buf, len) {
            debug('onReceiveClientHttp', wsi, buf, len);
    ...
    rest.ssl_connection ??= LCCSCF_USE_SSL | LCCSCF_ALLOW_SELFSIGNED | LCCSCF_SKIP_SERVER_CERT_HOSTNAME_CHECK | LCCSCF_ALLOW_EXPIRED | LCCSCF_ALLOW_INSECURE;
