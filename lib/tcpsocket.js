...
import { define, mapper, makeFireEvent, waitWrite, states, CONNECTING, OPEN, CLOSED } from './lws/util.js';
...
export class TCPSocket extends EventTargetProperties(['accept', 'open', 'error', 'message', 'timeout', 'close']) {
  ...
  /** Node's `tlsSocket.getPeerCertificate()`-equivalent: `{ subjectCN,
      ...
      TLS connection / no peer cert was presented. */
  get peerCertificate() {
