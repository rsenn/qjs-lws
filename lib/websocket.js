...
export class WebSocket extends EventTarget {
  ...
  constructor(url, protocols) {
    ...
    WebSocket.#lws2act.set(this.#wsi, act);
    WebSocket.#ws2lws.set(this, this.#wsi);
  ...
  static #ctx = null;
  static #ws2lws = mapper();
  static #lws2act = mapper();

  static #createContext(act = wsi => this.#lws2act.get(wsi)) {
  ...
  static waitWrite(ws) {
    return new Promise((resolve, reject) => this.#ws2lws(ws).wantWrite(resolve));
  }
}
...
Object.defineProperties(WebSocket.prototype, { binaryType: { value: 'arraybuffer', writable: true, configurable: false } });
