      ...
      protocols: [
        {
          ...
          onClientClosed: (wsi, reason, status) => (act(wsi).state(CLOSED).event('close', { code, reason }), 0),
...
function define(obj, props) {
  for(let prop in props) Object.defineProperty(obj, prop, { value: props[prop], configurable: true });
}
