...
export class Body {
  ...
  blob() {
    ...
    if(this.#chunks) return readStream(this.body).then(arr => Promise.resolve(new Blob(arr)));
  }
  ...
  arrayBuffer() {
    ...
    if(this.#chunks) return readStream(this.body).then(arr => Promise.resolve(new Blob(arr).arrayBuffer()));
  }
  ...
  text() {
    ...
    if(this.#chunks) return readStream(this.body).then(arr => Promise.resolve(new Blob(arr).text()));
  }
