...
import { assign, isPrototypeOf, verbose, waitWrite, weakMapper, getCallbackName, LWS_SERVER_OPTION_ALLOW_HTTP_ON_HTTPS_LISTENER, LWS_SERVER_OPTION_ALLOW_NON_SSL_ON_SSL_PORT, LWS_SERVER_OPTION_DO_SSL_GLOBAL_INIT, LWS_SERVER_OPTION_IGNORE_MISSING_CERT, LWS_SERVER_OPTION_PEER_CERT_NOT_REQUIRED, LWS_SERVER_OPTION_VH_H2_HALF_CLOSED_LONG_POLL, LWS_WRITE_HTTP, LWS_WRITE_HTTP_FINAL, LWSMPRO_CALLBACK, LWSMPRO_FILE, LWSMPRO_HTTP, LWSMPRO_NO_MOUNT, LWSSPA, toString, } from 'lws.so';
    ...
    protocols: [
      {
        ...
        async onReceive(wsi, data) {
          let str = (typeof data == 'string' ? data : toString(data)).replace(/\n/g, '\\n');
