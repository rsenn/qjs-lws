...
function ReadableByteStreamControllerCallPullIfNeeded(controller) {
  ...
  const hasPendingReads =
    (ReadableStreamHasDefaultReader(stream) && ReadableStreamGetNumReadRequests(stream) > 0) || (ReadableStreamHasBYOBReader(stream) && ReadableStreamGetNumReadIntoRequests(stream) > 0);
