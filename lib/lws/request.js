...
export class Request extends Body {
  ...
  constructor(input, options = {}) {
    ...
    if(input instanceof Request) {
      ...
      // Normalize URL per WHATWG spec
      try {
        this.url = Object.assign(new URL(String(input)), { hash: '' }).href;
      } catch(e) {
        // If URL parsing fails, just store the string as-is
    ...
    // Infer Content-Type for string bodies per WHATWG spec
