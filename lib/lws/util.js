...
import { LWS_WRITE_HTTP, LWS_WRITE_HTTP_FINAL, log, LLL_USER } from 'lws';
...
export function verbose(name, ...args) {
  console.log('\x1b[2K\r\x1b[0;31mUSER\x1b[0m ' + padEnd(name + '', 32), console.config({ compact: true }), LC, ...args);
}
