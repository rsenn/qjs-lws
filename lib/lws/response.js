...
export class Response extends Body {
  ...
  /**
   * Append a Set-Cookie header. Non-standard but kept for backward compatibility.
   * @param  {string} name
   * @param  {string} value
   * @param  {object} [opts]   { maxAge, domain, path, expires, httpOnly, secure, sameSite }
  ...
  /**
   * Append a Set-Cookie header that expires the named cookie immediately. Non-standard.
   * @param  {string} name
   * @param  {object} [opts]
   * @return {Response}
   */
