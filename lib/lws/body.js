...
export class Body {
  ...
  arrayBuffer() {
    ...
    if (this.#bodyArrayBuffer) return Promise.resolve(ArrayBuffer.isView(this.#bodyArrayBuffer) ? this.#bodyArrayBuffer.buffer.slice(this.#bodyArrayBuffer.byteOffset, this.#bodyArrayBuffer.byteOffset + this.#bodyArrayBuffer.byteLength) : this.#bodyArrayBuffer);
