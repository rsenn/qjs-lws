import { CONTEXT_PORT_NO_LISTEN,LLL_ERR,LLL_WARN, LLL_USER, LWSContext, logLevel, getLogLevelName, getLogLevelColour, LWS_SERVER_OPTION_ALLOW_NON_SSL_ON_SSL_PORT, LWS_SERVER_OPTION_CREATE_VHOST_SSL_CTX, LWS_SERVER_OPTION_DO_SSL_GLOBAL_INIT, LWS_SERVER_OPTION_IGNORE_MISSING_CERT, LWS_SERVER_OPTION_ONLY_RAW, LWS_SERVER_OPTION_PEER_CERT_NOT_REQUIRED, LWS_SERVER_OPTION_REDIRECT_HTTP_TO_HTTPS, LWS_SERVER_OPTION_ADOPT_APPLY_LISTEN_ACCEPT_CONFIG} from 'lws';
import { existsSync, readFileSync } from 'fs';

const { DEBUG, HOSTNAME } = process.env;

logLevel((DEBUG ? LLL_USER : 0)|LLL_ERR|LLL_WARN, (level, msg) => console.log('\x1b[2K\r\x1b[0;30m' + getLogLevelColour(level).replace(/\b38\b/g, '48') + centerPad(8, getLogLevelName(level)) + '\x1b[0m ' + msg));
