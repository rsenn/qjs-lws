import { ReadableStreamDefaultReader, ReadableStreamAsyncIteratorImpl, ReadableStreamBYOBRequest, ReadableByteStreamController, ReadableStreamBYOBReader, WritableStream, WritableStreamDefaultWriter, WritableStreamDefaultController, ReadableStreamDefaultController, ReadableStream, ByteLengthQueuingStrategy, CountQueuingStrategy, TransformStream, TransformStreamDefaultController, } from './streams.js';
import { define, wrapFunction, iteratorProperty } from './util.js';
