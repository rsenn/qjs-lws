...
function writableToFd(fd) {
  ...
  return new WritableStream({
    write(chunk) {
      const buf = typeof chunk === 'string' ? encoder.encode(chunk).buffer : ArrayBuffer.isView(chunk) ? chunk.buffer.slice(chunk.byteOffset, chunk.byteOffset + chunk.byteLength) : chunk;
