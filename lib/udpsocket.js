...
export class UDPSocket extends EventTargetProperties(['open', 'error', 'message', 'close']) {
  ...
  /**
   * Enables or disables broadcast mode. Not yet implemented - needs lws
   * socket option support. Currently a no-op.
   */
  setBroadcast(flag) {
  ...
  /**
   * Sets the IP time-to-live (TTL) for outgoing datagrams. Not yet
   * implemented - needs lws socket option support. Currently a no-op.
   */
  setTTL(ttl) {
  ...
  /**
   * Joins a multicast group. Not yet implemented - needs lws multicast
   * support. Currently throws Error.
   */
  addMembership(multicastAddress, multicastInterface) {
    throw new Error('UDPSocket.addMembership() not yet implemented - needs lws multicast support');
  }

  /**
   * Leaves a multicast group. Not yet implemented - needs lws multicast
   * support. Currently throws Error.
   */
  dropMembership(multicastAddress, multicastInterface) {
    throw new Error('UDPSocket.dropMembership() not yet implemented - needs lws multicast support');
  }

  /**
   * Sets the multicast TTL for outgoing datagrams. Not yet implemented -
   * needs lws multicast support. Currently a no-op.
   */
  setMulticastTTL(ttl) {
  ...
  /**
   * Enables or disables multicast loopback. Not yet implemented - needs
   * lws multicast support. Currently a no-op.
   */
  ...
  /**
   * Sets the multicast interface for outgoing datagrams. Not yet
   * implemented - needs lws multicast support. Currently a no-op.
   */
  ...
  /**
   * Joins a source-specific multicast group (SSM). Not yet implemented -
   * needs lws SSM support. Currently throws Error.
   */
  addSourceSpecificMembership(sourceAddress, groupAddress, multicastInterface) {
    throw new Error('UDPSocket.addSourceSpecificMembership() not yet implemented - needs lws SSM support');
  }

  /**
   * Leaves a source-specific multicast group (SSM). Not yet implemented -
   * needs lws SSM support. Currently throws Error.
   */
  dropSourceSpecificMembership(sourceAddress, groupAddress, multicastInterface) {
    throw new Error('UDPSocket.dropSourceSpecificMembership() not yet implemented - needs lws SSM support');
  }
