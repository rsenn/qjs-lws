...
export function list_head(data) {
 ...
 */
export function list_sort(head, cmp = (a, b) => a - b) {
...
export class List {
  ...
  popFront() {
    ...
    //if(list_empty(this.#head)) return;
   ...
   */
  *[Symbol.iterator]() {
    for(let node of list_for_each_safe(this.#head)) yield node.data;
  }
}
