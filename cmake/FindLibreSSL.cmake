macro(find_libressl)
  ...
  find_path(LIBRESSL_INCLUDE_DIR NAMES libressl/ssl.h PATH_SUFFIXES include HINTS ${LIBRESSL_ROOT_DIR}
                                                                                  ${_EXTRA_FIND_ARGS})
  ...
  find_library(LIBRESSL_CRYPTO_LIBRARY NAMES ${_LIBRESSL_CRYPTO_LIB_NAME} PATH_SUFFIXES lib HINTS ${LIBRESSL_ROOT_DIR}
                                                                                                  ${_EXTRA_FIND_ARGS})
  find_library(LIBRESSL_SSL_LIBRARY NAMES ${_LIBRESSL_SSL_LIB_NAME} PATH_SUFFIXES lib HINTS ${LIBRESSL_ROOT_DIR}
                                                                                            ${_EXTRA_FIND_ARGS})
  find_library(LIBRESSL_TLS_LIBRARY NAMES ${_LIBRESSL_TLS_LIB_NAME} PATH_SUFFIXES lib HINTS ${LIBRESSL_ROOT_DIR}
                                                                                            ${_EXTRA_FIND_ARGS})
  ...
  find_package_handle_standard_args(
    libreSSL FOUND_VAR LIBRESSL_FOUND REQUIRED_VARS LIBRESSL_INCLUDE_DIR LIBRESSL_SSL_LIBRARY LIBRESSL_CRYPTO_LIBRARY
  ...
  if(LIBRESSL_FOUND)
    if(NOT TARGET libcrypto)
      ...
      set_target_properties(
        libcrypto
        PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${LIBRESSL_INCLUDE_DIR}" IMPORTED_LINK_INTERFACE_LANGUAGES "C"
    ...
    if(NOT TARGET libssl)
      ...
      set_target_properties(
        libssl PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${LIBRESSL_INCLUDE_DIR}" INTERFACE_LINK_LIBRARIES libtls
                          IMPORTED_LINK_INTERFACE_LANGUAGES "C" IMPORTED_LOCATION "${LIBRESSL_SSL_LIBRARY}")
    endif()

    if(NOT TARGET libtls)
      add_library(libtls UNKNOWN IMPORTED)
      set_target_properties(
        libtls PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${LIBRESSL_INCLUDE_DIR}" INTERFACE_LINK_LIBRARIES libcrypto
                          IMPORTED_LINK_INTERFACE_LANGUAGES "C" IMPORTED_LOCATION "${LIBRESSL_TLS_LIBRARY}")
    endif()
